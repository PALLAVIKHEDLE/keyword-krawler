...
export default function CustomizedTables({ recommendationListData }) {
  return (
    <TableContainer component={Paper} style={{ padding: 3, minidth: "45%" }}>
        ...
        <TableBody>
          {recommendationListData?.topKeywordListings.map((keyword, index) => (
            <StyledTableRow key={index}>
              ...
              <StyledTableCell align="center">{keyword.count}</StyledTableCell>
              <StyledTableCell align="center">
              ...
              <StyledTableCell align="center">
                {keyword.mostSearchedAlternatives?.map(
